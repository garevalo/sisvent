...
<div id="modal-danger" class="modal modal-message modal-danger fade in" style="display: none; padding-right: 17px;" aria-hidden="false"><div class="modal-backdrop fade in" style="height: 477px;"></div>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
...
<div id="modal-warning" class="modal modal-message modal-warning fade" style="display: none;z-index: 999999; " aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <i class="fa fa-warning"></i>
                </div>
                <div class="modal-title" id="warning-title">Warning</div>

                <div class="modal-body" id="warning-body">Is something wrong?</div>
                <div class="modal-footer">
