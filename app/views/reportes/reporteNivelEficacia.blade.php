       ...
       <div class="col-lg-3 col-sm-6 col-xs-12">
                <div class="widget">
                    <div class="widget-header bordered-top bordered-palegreen">
                        <span class="widget-caption">Nivel de Eficacia Para Cierre de Ventas</span>
                    ...
                    <div class="widget-body">
                        <div class="collapse in">
                            ...
                            <div class="form-group ">
                                {{ Form::open(array('url' => 'reportes/reporteniveleficaciaajax',"id"=>"form",'class'=>"form-horizontal",'role'=>'form','method' => 'post'))}}    
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label>Desde :</label>
